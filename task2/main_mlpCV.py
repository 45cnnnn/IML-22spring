...
parameters = np.array([1.5, 2.0, 2.0, 2.5, 2.0, 1.5, 1.0, 2.0, 2.0, 1.0])
...
#---------------------- Sub Task 3 ----------------------#
parameters2  = {'alpha':[5.5,6,6.5,7,7.5,8,8.5,9,9.5,10,10.5,11,11.5,12]}
...
#---------------------- Output ----------------------#
y_pred.to_csv('prediction9.zip', index=False, float_format='%.3f', compression='zip')
y_pred.to_csv('prediction9.csv', index = False, float_format='%.3f')